                ...
                {engineOpen && (
                  <>
                    ...
                    <div
                      ...
                      className="absolute bottom-full mb-2 left-0 z-50 w-64 rounded-2xl bg-[color:var(--surface-modal)] backdrop-blur-xl border border-[color:var(--glass-border)] shadow-2xl py-1.5 animate-fade-up"
                    >
                      {MODES.map((mm) => (
                        <button
                          key={mm.id}
