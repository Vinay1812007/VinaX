...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: 'What is VinaX AI?', a: 'A full chat assistant: pick from eighteen engines (or let VinaX AUTO choose), search the live web, attach images or files, dictate with the mic or talk hands-free in voice mode. Ask for music — “play <song>” — and the reply is a live mini-player right in the chat, with lyrics singing along.' },
  { q: 'What are the engines?', a: 'Eighteen, each under its VinaX name: VinaX NVD NMTRN 3.5 LTNG 30B is the big creative engine that runs the AI DJ; VinaX NVD NMTRN SUP thinks deepest; VinaX NVD NMTRN ULT is the most powerful all-rounder; VinaX GRQ ALL knows music and answers in a blink and powers live voice; VinaX CGT 20B is fastest; VinaX CGT 120B is the heavyweight; VinaX DP V4 PRO does deep analysis; VinaX DP V4 FLASH is the rapid generalist; VinaX MIMX M3 the dependable all-rounder; VinaX K3 the premium agent; VinaX NVD NMTRN finds songs; plus VinaX DIF GEM, MUSE GMR 30B, GEM 4 31B, LGNA XS 2.1, the ING CALBTN pair and the NN30B A3B omni reasoner. Every reply shows a small chip naming the engine that actually answered.' },
