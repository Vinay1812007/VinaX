...
Live at **https://www.sirimillavinay.online** — Telugu, Hindi, Tamil and 9 more languages, with smart mixes, live charts, an AI DJ, synced lyrics, and an Android app.
...
- **Admin console:** `https://admin.sirimillavinay.online` (SPA served from `frontend/public/admin`, API at `/api/admin/*`, gated by `ADMIN_LOGIN_PASSWORD`); 26 tools organized under eight formal categories with collapsible sidebar groups (v5.7.5); the listener sidebar carries an Ads placeholder page (no ad scripts yet, v5.7.6).
