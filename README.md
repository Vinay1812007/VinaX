...
- **AI features:** seven model "lanes" (chat, quick answers, deep thinking, music Q&A, DJ/mixes, home-screen builder, search expert), each pinned to its own provider + key in `backend/worker/functions/_lib/ai.ts`.
